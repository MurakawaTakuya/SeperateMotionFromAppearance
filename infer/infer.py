...
def inference(
    ...
    with torch.autocast(device, dtype=torch.half):
        ...
        for i in range(repeat_num):
            ...
            # noise_path = f'/mnt/dolphinfs/hdd_pool/docker/user/hadoop-imagen/liuhuijie03/liuhuijie-fincv/school/qkv/exp/oneshot/noise/{video_name}/{infer_class}_{seed}.pt'
            # init_latents=torch.load(noise_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-r", "--seed", type=int, default=200106127, help="Random seed to make generations reproducible.")
    parser.add_argument("-np", "--noise_prior", type=float, default=0.2, help="Scale of the influence of inversion noise.")
    ...
    motion_name = args.checkpoint_folder.split('/')[-1]
